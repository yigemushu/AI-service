...
export const businessGuides: Record<BusinessType, string> = {
  ...
  virtual: "重点识别写作、润色、PPT、简历、设计、AI 生成、咨询等虚拟服务需求；关注用途、字数/页数、素材、截止时间、语气风格、交付格式、修改次数和报价边界；不要追问收货地址、快递、包邮或库存。",
...
export const defaultTemplates: MessageTemplate[] = [
  ...
  { id: "tpl_xianyu_virtual_service", name: "虚拟服务确认", businessType: "virtual", scenario: "写作、润色、检讨书、道歉信、PPT、简历、设计、AI生成等非实体服务", requiredInfo: "具体内容/事件经过\n用途/使用场景\n字数/页数/工作量\n语气风格\n截止时间\n交付格式\n修改次数/验收边界", content: "可以的，我先帮你看下需求。\n\n麻烦你发我具体内容、用途/场景、字数/页数、想要的语气风格、截止时间和需要的格式，我确认工作量后给你报价哈~", enabled: true, createdAt: now, updatedAt: now },
